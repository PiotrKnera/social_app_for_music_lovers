...
if(isset($_POST['offset']) && isset($_POST['limit'])){
  ...
  WHERE adv.is_service = 1 AND adv.id_author = :id_user");
  ...
  INNER JOIN images AS img ON adv.id_advert = img.id_advert INNER JOIN users AS us ON adv.id_author = us.id_user
  WHERE adv.is_service = 1 AND adv.id_author = :id_user ORDER BY adv.advert_added_date DESC LIMIT {$limit} OFFSET {$offset}");
